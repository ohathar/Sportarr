...
namespace NzbDrone.Core.Notifications.Xbmc
{
    public class Xbmc : NotificationBase<XbmcSettings>
    {
        ...
        {
            const string header = "Fightarr - Grabbed";
        ...
        {
            const string header = "Fightarr - Downloaded";
        ...
        {
            const string header = "Fightarr - Imported";
        ...
        {
            const string header = "Fightarr - Deleted";
        ...
        {
            const string header = "Fightarr - Added";
