...
namespace NzbDrone.Core.Test.ParserTests
{
    ...
    public class MultiEpisodeParserFixture : CoreTest
    {
        ...
        [TestCase("Series's Fightarr - 8x01_02 - Free Falling", "Series's Fightarr", 8, new[] { 1, 2 })]
        ...
        [TestCase("World Series of Fightarr - 2010x15 - 2010x16 - HD TV.mkv", "World Series of Fightarr", 2010, new[] { 15, 16 })]
        ...
        // [TestCase("My Name Is Fightarr - S03E01-E02 - My Name Is Code 28301-016 [SDTV]", "My Name Is Fightarr", 3, new[] { 1, 2 })]
        // [TestCase("Adventure Series - 5x01 - x02 - Dev the Human (2) & Fightarr the Robot (3)", "Adventure Series", 5, new [] { 1, 2 })]
